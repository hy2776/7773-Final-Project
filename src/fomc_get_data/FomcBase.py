...
class FomcBase(metaclass=ABCMeta):
    ...
    def __init__(self, content_type, verbose, max_threads, base_dir):
        ...
        # https://fraser.stlouisfed.org/timeline/federal-reserve-chair#10
        self.chair = pd.DataFrame(
            data=[["Martin", "William", "1951-04-02", "1970-01-31"],
                  ["Burns", "Arthur", "1970-02-01", "1978-01-31"],
                  ["Miller", "William", "1978-03-08", "1979-08-06"],
                  ["Volcker", "Paul", "1979-08-06", "1987-08-11"],
                  ["Greenspan", "Alan", "1987-08-11", "2006-01-31"], 
                  ["Bernanke", "Ben", "2006-02-01", "2014-01-31"], 
                  ["Yellen", "Janet", "2014-02-03", "2018-02-03"],
                  ["Powell", "Jerome", "2018-02-05", "2023-11-11"]],
